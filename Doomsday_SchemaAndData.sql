...
GO
ALTER DATABASE [DoomsdayDatabase] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [DoomsdayDatabase].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [DoomsdayDatabase] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET ARITHABORT OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [DoomsdayDatabase] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [DoomsdayDatabase] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET  ENABLE_BROKER 
GO
ALTER DATABASE [DoomsdayDatabase] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [DoomsdayDatabase] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET RECOVERY FULL 
GO
ALTER DATABASE [DoomsdayDatabase] SET  MULTI_USER 
GO
ALTER DATABASE [DoomsdayDatabase] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [DoomsdayDatabase] SET DB_CHAINING OFF 
GO
ALTER DATABASE [DoomsdayDatabase] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [DoomsdayDatabase] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [DoomsdayDatabase] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [DoomsdayDatabase] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'DoomsdayDatabase', N'ON'
GO
ALTER DATABASE [DoomsdayDatabase] SET QUERY_STORE = OFF
GO
